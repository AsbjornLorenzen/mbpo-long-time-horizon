...
def train(
    ...
    # ------------------- Initialization -------------------
    work_dir = os.getcwd()
    if len(cfg.overrides.prev_experiment_dir) == 0:
        print("Running MACURA algorithm from a fresh start!")
        load_checkpoints = False
    else:
        print("Running MACURA algorithm from a checkpoint in {cfg.prev_experiment_dir}!")
        checkpoint_dir = cfg.overrides.prev_experiment_dir
    ...
    # Load agent data from previously trained model
